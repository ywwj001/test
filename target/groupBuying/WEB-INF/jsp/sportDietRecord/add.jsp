...
<div style="width: 700px; padding-top: 10px;">
    <form id="form_submit" class="layui-form"><div class="layui-form-item">
            <label class="layui-form-label">摄入热量</label>
            <div class="layui-input-inline">
                <input type="text" name="calorieIn"
                       lay-reqText="请输入摄入热量"
                       placeholder="请输入摄入热量"
                       lay-verify="required" placeholder="请输入摄入热量" value=""
                       class="layui-input"/>
            </div>
        </div><div class="layui-form-item">
            <label class="layui-form-label">消耗热量</label>
            <div class="layui-input-inline">
                <input type="text" name="calorieOut"
                       lay-reqText="请输入消耗热量"
                       placeholder="请输入消耗热量"
                       lay-verify="required" placeholder="请输入消耗热量" value=""
                       class="layui-input"/>
            </div>
        </div><div class="layui-form-item">
            <label class="layui-form-label">计算结果</label>
            <div class="layui-input-inline">
                <input type="text" name="calorieBalance"
                       lay-reqText="请输入计算结果"
                       placeholder="请输入计算结果"
                       lay-verify="required" placeholder="请输入计算结果" value=""
                       class="layui-input"/>
            </div>
        </div><div class="layui-form-item">
            ...
            <label class="layui-form-label">饮食目标</label>
            <div class="layui-input-inline">
                <input type="text" name="dietTarget"
                       lay-reqText="请输入饮食目标"
                       placeholder="请输入饮食目标"
                       lay-verify="required" placeholder="请输入饮食目标" value=""
                       class="layui-input"/>
            </div>
        </div><div class="layui-form-item">
