...
<div style="width: 700px; padding-top: 10px;">
    <form id="form_submit" class="layui-form">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">营养师昵称</label>
            <div class="layui-input-inline">
                <input type="text" name="nickName"
                       lay-reqText="请输入营养师昵称"
                       placeholder="请输入营养师昵称"
                       lay-verify="required" placeholder="请输入营养师昵称" value=""
                       class="layui-input"/>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="price"
                       lay-reqText="请输入价格"
                       placeholder="请输入价格"
                       lay-verify="required|number" placeholder="请输入价格" value=""
                       class="layui-input"/>
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    var modleName = '${ctxPath}/dietitian';
        ...
        postData({
            ...
            success: function (res) {
                if (res.code === 0) {
                    ...
                    //图片
                    $('#headImgShow').attr('src', '${ctxPath}/' + data.avatarUrl);
                    $('#headImgShow').show(500);
                    form.render();
                } else {
                    layer.msg(res.msg, {icon: 5, anim: 6, time: 3000});
