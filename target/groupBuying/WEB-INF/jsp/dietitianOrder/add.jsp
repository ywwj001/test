    ...
    <form id="form_submit" class="layui-form"><div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="payPrice"
                       lay-reqText="请输入 支付金额"
                       placeholder="请输入 支付金额"
                       lay-verify="required" placeholder="请输入 支付金额" value=""
                       class="layui-input"/>
            </div>
            ...
            <label class="layui-form-label">营养师</label>
            <div class="layui-input-inline">
                <input type="text" name="dietitianId"
                       lay-reqText="请输入营养师"
                       placeholder="请输入营养师"
                       lay-verify="required" placeholder="请输入营养师" value=""
                       class="layui-input"/>
            </div>
        </div><div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="appointmentTime"
                       lay-reqText="请输入预约时间"
                       placeholder="请输入预约时间"
                       lay-verify="required" placeholder="请输入预约时间" value=""
                       class="layui-input"/>
            </div>
        </div> <div class="layui-form-item">
...
<script>
    var modleName = '${ctxPath}/dietitianOrder';
