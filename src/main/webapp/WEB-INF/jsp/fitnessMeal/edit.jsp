...
<div style="width: 700px; padding-top: 10px;">
    <form id="form_submit" class="layui-form">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">健身餐名称</label>
            <div class="layui-input-inline">
                <input type="text" name="name"
                       lay-reqText="请输入健身餐名称"
                       placeholder="请输入健身餐名称"
                       lay-verify="required" placeholder="请输入健身餐名称" value=""
                       class="layui-input"/>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="constituents"
                       lay-reqText="请输入主要成分"
                       placeholder="请输入主要成分"
                       lay-verify="required" placeholder="请输入主要成分" value=""
                       class="layui-input"/>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="crowd"
                       lay-reqText="请输入适合人群"
                       placeholder="请输入适合人群"
                       lay-verify="required" placeholder="请输入适合人群" value=""
                       class="layui-input"/>
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    var modleName = '${ctxPath}/fitnessMeal';
    ...
    layui.use(['element', 'laydate', 'upload', 'form'], function () {
        ...
        form.on("submit(btn_form_submit)", function (data) {
            ...
            if (!html) {
                layer.msg('请填写做法', {icon: 5, anim: 6, time: 3000});
                return;
            }
